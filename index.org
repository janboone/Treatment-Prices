...
#+name: Comparative_static_lambda
...
#+name: Linear_pricing_profit_margins
...
#+name: Linear_pricing_comparative_statics
...
*Proof of Lemma [[Baseline_results]]*
Because
\begin{equation}
\label{eq:16}
...
*Proof of Lemma [[Hotelling_equilibrium]]*
...
*Proof of Lemma [[Two_part_tariff]]*
...
*Proof of Lemma [[Comparative_static_lambda]]*
...
*Proof of lemma [[Linear_pricing_premium]]*
...
\end{equation}
Using the results in lemma [[Baseline_results]] we can write this equation as eqref:eq:52.
...
*Proof of lemma [[Linear_pricing_profit_margins]]*
...
*Proof of proposition [[Linear_price_above_value]]*
...
*Proof of lemma [[Linear_pricing_comparative_statics]]*
...
\end{equation}
This expression is negative, as can be seen as follows. We know from lemma [[Linear_pricing_profit_margins]] that $\mu_l>\mu_h$ which can be written as
\begin{equation}
\label{eq:70}
...
*Proof of Corollary [[Targeting_profitable]]*
