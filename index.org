...
In the next section we discuss the empirical evidence that supports the assumption that low types want to buy the generous high type contract. Further, our analysis is related to the following strands of literature. 
